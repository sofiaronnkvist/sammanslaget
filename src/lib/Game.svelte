<script>
  ...
  var buildUrl = 'Build';
  var loaderUrl = buildUrl + './Test/Build/Test.loader.js.gz';
  var config = {
    dataUrl: buildUrl + './Test/Build/Test.data.unityweb.gz',
    frameworkUrl: buildUrl + './Test/Build/Test.framework.js.unityweb.gz',
    codeUrl: buildUrl + './Test/Build/Test.wasm.unityweb.gz',
